...
int	main()
{
	...
	printf("s3 : %s\n", s3);
	printf("c : %c\n", ft_itoa(-1)[0]);
	if (s3[11] != '\0' || ft_strncmp(s3 , "-2147483648", 11) != 0 || ft_itoa(0)[0] != '0'
			|| ft_itoa(-1)[0] != '-' || ft_itoa(-1)[1] != '1' || ft_itoa(-1)[2] != '\0'
			|| ft_itoa(1337)[4] != '\0' || ft_strncmp(ft_itoa(2147483647) , "2147483647", 10) != 0
			|| ft_strncmp(ft_itoa(0) , "0", 10) != 0 
			|| ft_strncmp(ft_itoa(-1337) , "-1337", 10) != 0
			|| ft_strncmp(ft_itoa(1) , "1", 10) != 0 || ft_strncmp(ft_itoa(1337) , "1337", 10) != 0)
	{
