...
int	main()
{
	...
	if (ft_strrchr((const char *)"12", 125) != strrchr((const char *)"12", 125)
			|| ft_strrchr((const char *)"123456", 48 + 6) != strrchr((const char *)"123456", 48 + 6)
			|| ft_strrchr((const char *)"", 0) != strrchr((const char *)"", 0)
			|| ft_strrchr((const char *)"1", 48 + 1 ) != strrchr((const char *)"1", 48 + 1)
			|| ft_strrchr((const char *)"12345678", 48 + 5) != strrchr((const char *)"12345678", 48 + 5))
	{
