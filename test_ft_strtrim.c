...
int	main()
{
	...
	if (s3[44] != '\0' || ft_strncmp(ft_strtrim("##__--  123456789", s2) , "123456789", 10) != 0
			|| ft_strtrim("", "")[0] != '\0' || ft_strtrim("1", "")[0] != '1'
			|| ft_strtrim("", "1")[0] != '\0' || ft_strtrim("1", NULL)[0] != '1'
			|| ft_strtrim(NULL, "4343") != NULL)
	{
