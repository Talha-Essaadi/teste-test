...
int	main()
{
	...
	if (ft_atoi("  -123abc") != atoi("  -123abc") || ft_atoi("   2147483647abc") != atoi("   2147483647abc")
			|| ft_atoi("  -2147483648abc") != atoi("  -2147483648abc")
			|| ft_atoi("123abc") != atoi("123abc") || ft_atoi("    +-123abc    ") != atoi("    +-123abc    ")
			|| ft_atoi("  	255") != atoi("  	255") || ft_atoi("   - 1234") != atoi("   - 1234")
			|| ft_atoi("2147483647") != atoi("2147483647") || ft_atoi("-2147483648") != atoi("-2147483648")
			|| ft_atoi("    ---000") != atoi("         ---000") || ft_atoi("") != atoi(""))
	{
